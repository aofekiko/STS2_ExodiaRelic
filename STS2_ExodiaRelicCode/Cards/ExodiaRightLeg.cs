    ...
    CustomCardModel(1, CardType.Power, CardRarity.Ancient, TargetType.Self)
{
    ...
    {
        ExodiaRightLeg cardSource = this;
        await CreatureCmd.TriggerAnim(cardSource.Owner.Creature, "Cast", cardSource.Owner.Character.CastAnimDelay);
        ExodiaRightLegPower exodiaRightLegPower = await PowerCmd.Apply<ExodiaRightLegPower>(cardSource.Owner.Creature, 1, cardSource.Owner.Creature, (CardModel) cardSource);
    }
