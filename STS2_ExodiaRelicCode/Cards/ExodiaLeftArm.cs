    ...
    CustomCardModel(1, CardType.Power, CardRarity.Ancient, TargetType.Self)
{
    ...
    {
        ExodiaLeftArm cardSource = this;
        await CreatureCmd.TriggerAnim(cardSource.Owner.Creature, "Cast", cardSource.Owner.Character.CastAnimDelay);
        ExodiaLeftArmPower exodiaLeftArmPower = await PowerCmd.Apply<ExodiaLeftArmPower>(cardSource.Owner.Creature, 1, cardSource.Owner.Creature, (CardModel) cardSource);
    }
