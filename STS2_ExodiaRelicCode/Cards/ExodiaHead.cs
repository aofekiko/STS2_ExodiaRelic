    ...
    CustomCardModel(1, CardType.Power, CardRarity.Ancient, TargetType.Self)
{
    ...
    {
        ExodiaHead cardSource = this;
        await CreatureCmd.TriggerAnim(cardSource.Owner.Creature, "Cast", cardSource.Owner.Character.CastAnimDelay);
        ExodiaHeadPower exodiaHeadPower = await PowerCmd.Apply<ExodiaHeadPower>(cardSource.Owner.Creature, 1, cardSource.Owner.Creature, (CardModel) cardSource);
    }
