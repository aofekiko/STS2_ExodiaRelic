    ...
    CustomCardModel(1, CardType.Power, CardRarity.Ancient, TargetType.Self)
{
    ...
    {
        ExodiaRightArm cardSource = this;
        await CreatureCmd.TriggerAnim(cardSource.Owner.Creature, "Cast", cardSource.Owner.Character.CastAnimDelay);
        ExodiaRightArmPower exodiaRightArmPower = await PowerCmd.Apply<ExodiaRightArmPower>(cardSource.Owner.Creature, 1, cardSource.Owner.Creature, (CardModel) cardSource);
    }
